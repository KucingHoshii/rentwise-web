<%-- 
    Document   : ownerReport
    Created on : 1 Jun 2024, 10:32:32 am
    Author     : nurs2
--%>
...
<head>
    ...
    <script>
        function filterByMonth() {
            ...
            window.location.href = "ownerReport.jsp?month=" + selectedMonth;
        }
...
<body>
            ...
            <select id="monthFilter" onchange="filterByMonth()">
                ...
                <%
                    ...
                    for (int i = 0; i < 12; i++) {
                        ...
                        out.println("<option value=\"" + (i + 1) + "\">" + monthName + "</option>");
                    }
                %>
            </select>
    ...
    <!-- Footer -->
    <footer>
        <p>RentWise Car Rental &copy; 2023. All rights reserved.</p>
    </footer>
</body>
</html>
